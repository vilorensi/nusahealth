        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            <Link to="/" className="flex-shrink-0 flex items-center">
              <span className="text-gray-800 text-xl font-bold hover:text-[#A7D7A5] transition-colors duration-300">
                nusahealth
              </span>
            </Link>
          </div>
          ...
          <div className="hidden lg:flex lg:items-center lg:space-x-4">
            {navItems.map((item) => (
              <Link
                key={item.path}
                to={item.path}
                className="flex items-center text-gray-700 hover:text-[#A7D7A5] px-3 py-2 text-sm font-medium transition-colors duration-300"
              >
          ...
          <div className="lg:hidden flex items-center">
            <button
              ...
              className="inline-flex items-center justify-center p-2 rounded-md text-gray-700 hover:text-[#A7D7A5] transition-colors duration-300"
          ...
          <div className="px-2 pt-2 pb-3 space-y-1">
            {navItems.map((item) => (
              <Link
                key={item.path}
                to={item.path}
                className="flex items-center px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-[#A7D7A5] transition-colors duration-300"
