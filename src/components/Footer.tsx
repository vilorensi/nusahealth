...
const Footer = () => {
  return (
    <footer className="bg-[#243010] text-white mt-20">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-bold text-lg mb-4">About SehatLink</h3>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} SehatLink Indonesia. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
