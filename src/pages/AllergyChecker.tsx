      ...
      const response = await fetch('https://api.openai.com/v1/chat/completions', {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: 'system',
              content: 'You are a medical AI assistant specializing in allergies and food sensitivities. Provide accurate information about allergies, symptoms, and potential triggers. Always include a disclaimer about consulting healthcare professionals.'
            },
            {
              role: 'user',
              content: question
