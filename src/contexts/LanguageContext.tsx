...
const translations = {
  en: {
    ...
    welcome: "Your Health Journey Starts Here",
    subtitle: "Access comprehensive healthcare services and information",
  ...
  id: {
    ...
    welcome: "Perjalanan Kesehatan Anda Dimulai Di Sini",
    subtitle: "Akses layanan dan informasi kesehatan yang komprehensif",
