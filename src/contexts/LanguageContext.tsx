...
const translations = {
  en: {
    ...
    welcome: "Free Health Info For All Indonesians",
    subtitle: "Access trusted Indonesian healthcare resources",
  ...
  id: {
    ...
    welcome: "Info Kesehatan Gratis Untuk Indonesia",
    subtitle: "Akses informasi kesehatan terpercaya untuk masyarakat Indonesia",
