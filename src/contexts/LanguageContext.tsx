...
const translations = {
  en: {
    ...
    subtitle: "Access trusted health resources to make informed decisions",
  ...
  id: {
    ...
    welcome: "Info Kesehatan Gratis",
    subtitle: "Akses sumber daya kesehatan terpercaya untuk keputusan tepat",
